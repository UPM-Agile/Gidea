...
// Model for Idea entity
    models.Idea = Backbone.Model.extend({
        ...
        sync: function(method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/GoodIdea/rest/idea/';
            }
    ...
    models.IdeaCollection = Backbone.Collection.extend({
        model: models.Idea,
        url: "http://localhost:8080/GoodIdea/rest/idea/",
        sync: function(method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function(jqXHR, textStatus, errorThrown) {
...
$(function() {
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        list: function() {
            this.collection = new models.IdeaCollection();
            var self = this;
