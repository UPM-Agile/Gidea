...
// Model for User entity
    models.User = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/GoodIdea/rest/user/",
        idAttribute: 'id',
        defaults: {
            id: "",
            email:"",
    ...
    models.UserCollection = Backbone.Collection.extend({
        model: models.User,
        url: "http://localhost:8080/GoodIdea/rest/user/",
        sync: function(method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function(jqXHR, textStatus, errorThrown) {
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        initialize: function() {
            ...
            $('#create').html(new views.CreateView({
                // tpl-user-create is template identifier for 'create' block
                templateName: '#tpl-user-create',
                navigate: function() {
